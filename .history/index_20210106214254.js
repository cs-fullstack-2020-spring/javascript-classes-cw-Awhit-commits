...
let problem2 =()=>{
    ...
    let thirdMovie = new Movie("Jackie Brown", "1999","5/5")
   ...
   <div>
        <h1>Second Movie</h1>
        <p>${secondMovie.movieTitle}</p>
        <p>${secondMovie.movieYear}</p>
        <p>${secondMovie.rating}</p>
        <h1>Third Movie</h1>
        <p>${thirdMovie.movieTitle}</p>
        <p>${thirdMovie.movieYear}</p>
        <p>${thirdMovie.rating}</p>
    </div>`)
}
problem2()